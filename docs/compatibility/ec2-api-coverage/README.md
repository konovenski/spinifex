...
Spinifex implements **121 of the 625** operations in the EC2 `2016-11-15` API model, as pinned in `aws-sdk-go v1.55.8` — **19.4%**.
...
| `DescribeSpotPriceHistory` | ❌ Not implemented |
